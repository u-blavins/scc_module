...
//        
        sharesbroker.Users currUsers = new sharesbroker.Users();
        List<sharesbroker.UserType> users = currUsers.getUsers();
        sharesbroker.UserType user;
        sharesbroker.UserType.UserShares userShare;
        
        user = new sharesbroker.UserType();
        user.setUsername("ublavins");
        user.setPassword("testpassword");
        user.setIsAdmin(1);
        userShare = new sharesbroker.UserType.UserShares();
        List<sharesbroker.UserType.UserShares> userShares = 
                user.getUserShares();
        userShare.setCompanyShares(100);
        userShare.setCompanySymbol("LLOY");
...
//        latest_shares.add(share);
        ...
        try {
            javax.xml.bind.JAXBContext jaxbCtx = 
                    javax.xml.bind.JAXBContext.newInstance(currUsers.getClass().getPackage().getName());
            javax.xml.bind.Marshaller marshaller = jaxbCtx.createMarshaller();
            marshaller.setProperty(javax.xml.bind.Marshaller.JAXB_ENCODING, "UTF-8");
            marshaller.setProperty(
                    javax.xml.bind.Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);
//            marshaller.marshal(currUsers, System.out);
            File file = new File("users.xml");
            marshaller.marshal(currUsers, file);
